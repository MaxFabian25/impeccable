...
- **Asking for a new font without context.** Typeset will pick based on the Design Context in `AGENTS.md`. If you have not run `$impeccable teach`, the suggestion will be generic.

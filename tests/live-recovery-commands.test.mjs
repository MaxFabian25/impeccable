...
import { createLiveSessionStore } from '../skills/impeccable/scripts/live-session-store.mjs';

const REPO_ROOT = process.cwd();
const STATUS_SCRIPT = join(REPO_ROOT, 'skills/impeccable/scripts/live-status.mjs');
const RESUME_SCRIPT = join(REPO_ROOT, 'skills/impeccable/scripts/live-resume.mjs');
const COMPLETE_SCRIPT = join(REPO_ROOT, 'skills/impeccable/scripts/live-complete.mjs');

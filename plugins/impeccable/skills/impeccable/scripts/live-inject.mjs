...
//
// Meta CSP blocks the injected live script and local event stream unless the
// localhost live origin is allowed. Patch only in-document meta tags here; CSP
// headers and framework config still belong to the explicit CSP reference flow.
// ---------------------------------------------------------------------------

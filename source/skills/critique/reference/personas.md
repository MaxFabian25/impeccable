...
If `PRODUCT.md` contains audience and brand information generated by `{{command_prefix}}impeccable teach`, derive 1-2 additional personas from it:
...
Only generate project-specific personas when real PRODUCT.md audience data is available. Don't invent audience details - use the 5 predefined personas when no context exists.
